        ...
        <>
            ...
            <AccordionGrid>
                <Accordion heading="ショップ登録方法">
                    <ListUl>
                        <ListFlow number={1}>
                            マイページから「<strong className="text-[var(--theme)]">ショップ登録</strong>」をクリック
                        </ListFlow>
                        <ListFlowArrow />
                        ...
                        <ListFlowArrow />
                        <ListFlow number={7}>
                            ショップ登録お申し込み完了、審査開始（1~2週間ほど頂戴いたしております）
                        </ListFlow>
                        <ListFlowArrow />
                ...
                <Accordion heading="ショップ登録条件">
                    <p className="mt-4">
                        <strong className="text-[var(--theme)]">ショップ登録</strong>
                ...
                <Accordion heading="オプションについて">
                    ...
                    <GuideSection heading="運営者情報を公開する">
                        プロフィールのショップ情報に、ショップ登録時にご入力いただいた会社情報（事業者情報）が公開されます。
                    </GuideSection>
                </Accordion>
            </AccordionGrid>
            ...
            <AccordionGrid>
                ...
                <Accordion heading="在庫登録について">
                    ...
                    <ListUl>
                        ...
                        <ListFlow number={2}>
                            商品ページの一番下までスクロールし、「
                            <span className="text-blue-700">商品の内容を変更する</span>
                            」をクリック、商品編集ページを開く
                        </ListFlow>
                        <ListFlowArrow />
                ...
                <Accordion heading="カラー、サイズ等種類の選択">
                    <p className="mt-4 mb-2">
                        ショップユーザーで、複数点出品した商品に限り、カラー・サイズ等種類の選択ができます。
                    </p>

                    <p className="font-bold">
                        出品ページの「個数」を2点以上にすると、「次へ」をクリックすると「カラー・サイズ等選択ページ」へ進みます。
                    </p>
                    <ListUl>
                ...
                <Accordion heading="ショップ情報の閲覧">
                    ...
                    <GuideSection heading="ショップ情報の表示方法">
                        <p className={styles.sectionChildP}>
                            <strong>プロフィール</strong>から「ショップ情報」をクリック
                        </p>
                    ...
                    <GuideSection heading="運営者情報について">
                        <p className={styles.sectionChildP}>
                            ...
                            <br />
                            ショップ情報を公開していない場合、運営者情報請求フォームから申請すると、メールにてショップ情報が送付されます。
                        </p>
                        <GuideSmall>
                            ※運営者情報開示メールの第三者への公開、転送、引用などはお断りしております。
                        </GuideSmall>
                    </GuideSection>
                </Accordion>
                ...
                <Accordion heading="ショップ情報の変更">
                    <p className="mt-4 mb-2">
                        マイページから「<strong>ショップ情報編集</strong>
                        」をクリックし、変更したい項目をクリックするとアクセスできます。
                    </p>

                    <p className="font-bold">
                        以下を変更する場合、審査が必要になります。審査を通過できなかった場合、変更できません。
                    </p>
                    <ListUl>
                    ...
                    <p className="mt-4">
                        ※<strong>代表者氏名</strong>を変更する場合、新しい代表者の<strong>顔写真付き身分証</strong>
                        が必要になります。
                    </p>
                </Accordion>
            </AccordionGrid>
