        ...
        <>
            ...
            <AccordionGrid>
                <Accordion heading="購入方法">
                    ...
                    <ListUl>
                        <ListFlow number={1}>
                            「<span className="text-blue-700">購入する</span>」ボタンをクリック
                        </ListFlow>
                        <ListFlowArrow />
                        ...
                        <ListFlowArrow />
                        <ListFlow number={4}>
                            <span className="text-red-600">購入完了</span>、
                            <span className="text-blue-700">購入した商品ページ</span>から配送状況を確認
                        </ListFlow>
                        <ListFlowArrow />
                        <ListFlow number={5}>
                            商品受け取り後、購入した商品ページの「<span className="text-blue-700">受け取りました</span>
                            」ボタンをクリックし、<span className="text-red-600">出品者評価</span>を行う
                        </ListFlow>
                    </ListUl>
                </Accordion>
                ...
                <Accordion heading="支払い方法">
                    ...
                    <GuideSmall>
                        ※ポイントは保有した日から180日後まで未使用である場合、無効になり弊社が回収いたします。
                    </GuideSmall>
                </Accordion>
            ...
            <AccordionGrid>
                <Accordion heading="商品ページの内容">
                    ...
                    <GuideSection heading="関連する商品">
                        <p className={styles.sectionChildP}>
                            主に同じジャンルの人気の商品や、興味がありそうな商品のリンクを掲載しています。
                        </p>
                    </GuideSection>
                ...
                <Accordion heading="動画のいいね・保存">
                    <p className="mt-4 mt-2">
                        商品ページから、動画の下にある「<strong className="text-[var(--theme)]">いいね</strong>
                        」ボタンを押すと、マイページの「<span className="text-blue-700">いいねした商品</span>
                        」から閲覧できます。
                    </p>
                </Accordion>
            ...
            <AccordionGrid>
                <Accordion heading="送料について">
                    <p className="mt-4 mb-2">
                        送料は<strong className="text-red-600">出品者の負担</strong>
                        となります。購入者からは頂戴しておりません。
                    </p>
                </Accordion>
                ...
                <Accordion heading="配送状況について">
                    <p className="mt-4 mb-2">
                        配送状況は、<strong className="text[var(--theme)]">購入明細ページの上部</strong>に表示されます。
                    </p>
                    ...
                    <p className="text-[var(--alart)] font-bold">
                        ※出品者が「発送しました」ボタンを押さなかった場合、発送済みでも「発送待ち」と表示されることがありますが、配送には問題ありません。
                    </p>
                    <p>
                        商品が到着し次第、「<strong className="text-[var(--theme)]">受け取りました</strong>
                        」ボタンを押し、出品者評価を行ってください。
                    </p>
                </Accordion>

                <Accordion heading="出品者評価について">
                    <p className="mt-4 mb-4">
                        商品の受け取りが完了し、「<strong className="text-[var(--theme)]">受け取りました</strong>
                        」ボタンをクリックしたら、<span className="text-blue-700">出品者評価</span>を行います。
                    </p>
                    ...
                    <p className="mt-2">
                        ...
                        <span className="text-[var(--alert)]">悪かった</span>」で選択できます。
                        <br />
                        取引に問題が無ければ「<span className="text-blue-700">良かった</span>」を選んでください。
                    </p>
                    <GuideSmall>
                        ※出品者評価を終えることにより、取引が完了したものとします。出品者への売上金の入金も同時に行われるため、必ず出品者評価をお願いします。
                    </GuideSmall>
                </Accordion>

                <Accordion heading="返金、返品、保証について">
                    <p className="mt-4 mb-2 font-bold text-[var(--alert)]">
                        弊社では返金、返品、保証等の対応は致しておりません。
                    </p>

                    <p>
                        商品の受け取り後、出品者とチャットでご相談のうえ、出品者のもとにご返品いただくことは可能です。
                    </p>
                    <GuideSmall>
                        ※返品の際は、必ず出品者が希望する住所または発送元の住所へご返品ください。弊社に送付されましても対応いたしかねます。
                    </GuideSmall>
                </Accordion>
                ...
                <Accordion heading="キャンセルについて">
                    ...
                    <p className="mt-4 mb-2 font-bold text-[var(--alert)]">
                        ※キャンセルした場合、支払額の10%のキャンセル料を徴収いたします。
                        <br />
                        キャンセル料は購入者負担となります。
                    </p>

                    <p>
                        商品の発送前であれば、購入明細ページからキャンセル申請可能です。出品者がキャンセル申請を承認すれば、キャンセルが成立します。
                    </p>
                    ...
                    <GuideSmall className="mt-4">
                        ...
                        <br />
                        ポイント変換の場合、キャンセル料を差し引いた額を即時ポイントに変換いたします。
                    </GuideSmall>
                </Accordion>
                ...
                <Accordion heading="商品が届かない">
                    ...
                    <p className="mt-6 mb-2 font-bold text-[var(--alert)]">
                        ※発送前でも、キャンセルせず購入から30日経過した場合、取引が完了したとみなします。この場合、返金等は一切いたしません。
                    </p>
                    <p className="mb-4">
                        商品が発送されない場合、必ず購入から<strong className="text-[var(--theme)]">30日以内</strong>
                        にキャンセル手続きを完了してください。
                    </p>

                    <GuideSmall>
                        ※キャンセル申請が承認されず、商品が30日経過後も発送されない場合、
                        <Link href="/inquiry" className="hover:underline text-blue-600 hover:text-blue-800">
                            お問い合わせフォーム
                        </Link>
                        からお問い合わせください。
                    </GuideSmall>
