        ...
        <Container header>
            ...
            <AccordionGrid>
                <Accordion heading='出品方法'>
                    ...
                    <ListUl>
                        <ListFlow number={1}>フッターの「出品する<FontAwesomeIcon icon={faSquarePlus} className='text-lg px-2 text-[var(--theme)]' />」ボタンをクリック（PCはヘッダー右側）</ListFlow>
                        <ListFlowArrow />
                        <ListFlow number={2}>動画、画像、価格など商品関連情報をアップロード</ListFlow>
                        <ListFlowArrow />
                        <ListFlow number={3}>プレビューで確認</ListFlow>
                        <ListFlowArrow />
                        <ListFlow number={4}><strong className='text-[var(--theme)]'>出品完了！</strong></ListFlow>
                    </ListUl>
                ...
                <Accordion heading='動画の内容'>
                    ...
                    <p className='mt-2'>
                        ...
                        <br />動画の概要は、動画の見どころとなる部分を文章で表現しましょう。また、商品の良さや特徴が伝わる内容にするとよいでしょう。
                    </p>
                ...
                <Accordion heading='商品関連情報の内容'>
                    ...
                    <GuideSmall>※商品が記載の内容と異なる、発送時に記載の内容と異なる方法へ発送するなどが確認された場合、ペナルティポイントが課されることがございます。責任をもって、正確な情報を記載するように心がけましょう。</GuideSmall>
                </Accordion>
            ...
            <AccordionGrid>
                <Accordion heading='売上金の入金時期、入金額'>
                    ...
                    <p className='block ml-[1rem] text-[var(--theme)]'><strong>購入者が商品を受け取り、出品者評価を完了したとき</strong></p>
                    <div className='ml-[2rem] mt-1'>
                        <p>購入者が出品者評価をしなかった場合、決済から<strong className='text-[var(--theme-sub)]'>30日後</strong>に入金されます。</p>
                        <GuideSmall>※規約違反などが確認された場合、入金されないことがございます。</GuideSmall>
                    </div>

                    <p className='mt-4 mb-2'>売上金の入金額</p>
                    <div className='ml-[1rem]'>
                        <p className='text-[var(--theme)]'><strong>商品代金から販売手数料を引いた額が入金されます。</strong></p>
                        <p>※商品代金の<strong className='text-[var(--theme-sub)]'>90%</strong>相当額</p>
                    </div>
                ...
                <Accordion heading='振込申請の方法'>
                    ...
                    <ListUl>
                        <ListFlow number={1}>マイページの「<strong className='text-[var(--theme)]'>振込申請</strong>」をクリック</ListFlow>
                        <ListFlowArrow />
                ...
                <Accordion heading='振込日について'>
                    <p className={clsx('mt-4 mb-2', styles.PHeading)}>振込申請を行った日の<span className='text-[var(--alert)]'>翌々週金曜日</span>に振込されます。</p>

                    <p className='font-bold'>※振込予定日が金融機関の休業日である場合、その翌営業日に振込されます。</p>

                    <GuideSmall>※弊社都合により、振込日が予定日から変動する可能性がございます。その場合、可能な限り前もってメール、サイト内お知らせ等で通知いたします。</GuideSmall>
                    <GuideSmall>※金利等による金額の変動はありません。</GuideSmall>
                </Accordion>

                <Accordion heading='売上金の保管期限'>
                    <p className={clsx('mt-4 mb-2', styles.PHeading)}>売上金の保管期限は、当該売上金が加算された日から<span className='text-[var(--alert)]'>180日後</span>です。</p>
                    ...
                    <GuideSmall>※スマートフォン等で文字が小さくて見づらい場合、画像をタップして全画面表示にしてください。</GuideSmall>

                    <p className='font-bold mt-4'>有効期限切れの売上金は、請求権を放棄したものとみなし、弊社が回収いたします。</p>
                    <GuideSmall>※期限が近付いたユーザーには、当サイトのお知らせまたはメールにて通知いたします。申請し忘れのないようにご注意ください。</GuideSmall>

                    <p className='font-bold mt-4'>事前に口座登録しているユーザーには、期限を経過した場合、登録されている口座にお振込みいたします。</p>
                    <GuideSmall>振込日：期限が経過した月の翌月の10日（金融機関が休業日の場合、翌営業日）</GuideSmall>
                </Accordion>

                <Accordion heading='振込申請の注意点'>
                    <GuideSection heading='振込申請は1,000円からです！'>振込申請の最低金額は<strong className='text-[var(--theme)]'>1,000円</strong>です。売上金が1,000円未満の場合、振込申請ができません。</GuideSection>
                    <GuideSection heading='振込が200円かかります。'>振込申請1回につき手数料<strong className='text-[var(--theme)]'>200円</strong>徴収いたします。一気にまとめて申請する方がお得です。</GuideSection>
                    <GuideSection heading='口座情報に不備がある場合、振込できません。その際も振込手数料200円発生します。'>振込できない場合も、振込手数料200円発生します。振込申請の際は、お間違いがないか慎重にご確認お願いします。</GuideSection>
                    <GuideSection heading='口座情報の誤りで第三者の口座に振り込んだ場合、組戻し手数料880円が発生します。'>口座情報にお間違いがないよう、慎重に確認を行ってください。</GuideSection>
                </Accordion>
            ...
            <AccordionGrid>
                <Accordion heading='動画・画像における禁止事項'>
                    ...
                    <p className='mt-4 mb-2'>詳しくは<Link href='/trams-and-conditions' className='text-blue-600 hover:underline hover:text-blue-800'>利用規約</Link>をご覧ください。</p>
                    <p className='text-[var(--alert)] font-bold'>※上記の禁止事項に違反した場合、即時ペナルティ対象となります。</p>
                </Accordion>
                ...
                <Accordion heading='出品における禁止事項'>
                    ...
                    <p className='mt-4 mb-2'>悪意がなく、過失による軽微な違反と弊社が判断した場合、警告のみとさせていただきます。なお、何度警告しても改善されない場合、上記の処分を科します。</p>
                    <p>※アカウント削除およびサービスの利用停止処分をされた場合、売上金およびポイントは全額没収となります。</p>
                </Accordion>
            </AccordionGrid>
            ...
            <AccordionGrid>
                <Accordion heading='送料について'>
                    <p className='mt-4 mb-2 font-bold'>送料は<span className='text-[var(--theme)]'>出品者の負担</span>となります。</p>

                    <p>発送時に配送会社が指定する額をお支払いください。</p>
                    <GuideSmall>※着払いで発送した、購入者に送料の支払いを強要した場合、ペナルティの対象となります。</GuideSmall>
                </Accordion>

                <Accordion heading='梱包について'>
                    <GuideSection heading='梱包する際は、必ず発送時と同じ状態を維持できるように梱包してください。'>ダンボールやクッション材などを使って、商品が壊れる、傷つく、汚れる、濡れる、腐る等ないようにしてください。</GuideSection>
                ...
                <Accordion heading='配送状況について'>
                    <p className='mt-4 mb-2'>配送状況は、<strong className='text[var(--theme)]'>取引明細ページの上部</strong>に表示されます。</p>
                    ...
                    <div className='mt-2 ml-[1rem]'>
                        <RowTextContainer heading='発送待ち→配送中：'>出品者が配送会社と配送手続きを完了し、取引明細ページの「<span className='text-blue-700'>発送しました</span>」ボタンを押したとき</RowTextContainer>
                    ...
                    <p className='text-[var(--alert)] font-bold'>※出品者が「発送しました」ボタンを押さなかった場合、発送済みでも「発送待ち」と表示されることがあります。購入者が受け取りをスムーズに行えない可能性があるため、必ず「発送しました」ボタンを押してください。</p>
                ...
                <Accordion heading='出品者評価'>
                    ...
                    <p className='ml-[1rem]'>出品者評価は「<span className='text-blue-700'>良かった</span>」「<span className='text-[var(--alert)]'>悪かった</span>」の二択で行っております。</p>
                    <p className='ml-[1rem]'>「<span className='text-[var(--alert)]'>悪かった</span>」場合、悪かった理由についての報告があります。</p>

                    <GuideSection heading='5つ星評価'>「<span className='text-blue-700'>良かった</span>」は5、「<span className='text-[var(--alert)]'>悪かった</span>」は1とし、平均値をユーザーネームの下に5つ星で表します。また、5つ星の右の数字は評価の件数です。</GuideSection>

                    <p className='mt-2 font-bold'>投稿ページに記載している内容と偽りがあると「<span className='text-[var(--alert)]'>悪かった</span>」がつきやすくなります。購入者から信頼される取引をして、高評価を目指しましょう！</p>

                    <GuideSection heading='出品者評価と売上金入金'>購入者が出品者評価を終えると売上金が入金されます。購入者が出品者評価をしなかった場合、購入から<strong className='text-[var(--theme)]'>30日後</strong>に売上金が入金されます。</GuideSection>
                </Accordion>

                <Accordion heading='キャンセル'>
                    <p className='mt-4 mb-2 font-bold'>購入者からの<span className='text-[var(--alert)]'>キャンセル申請</span>を承認したら、取引がキャンセルとなります。</p>
                    
                    <GuideSmall>※キャンセルされた場合、該当する商品は再び販売されます。</GuideSmall>
                    <GuideSmall>※キャンセル申請を承認または却下せず、放置し続けた場合、ペナルティの対象となる場合がございます。</GuideSmall>
                </Accordion>
            </AccordionGrid>
            ...
            <AccordionGrid>
                <Accordion heading='商品ページの内容'>
                    ...
                    <GuideSection heading='コメント'>動画や商品に対するユーザーのコメントを閲覧できます。また、ご自身でコメントを投稿することができます（ログインユーザーのみ）。</GuideSection>
                ...
                <Accordion heading='商品を編集したい'>
                    <ListUl>
                        <ListFlow number={1}>商品ページを開き、一番下までスクロールし、「<span className='text-blue-700'>商品の内容を変更する</span>」をクリックします。</ListFlow>
                        <ListFlowArrow />
                ...
                <Accordion heading='商品を削除したい'>
                    <ListUl>
                        <ListFlow number={1}>商品ページを開き、一番下までスクロールし、「<span className='text-blue-700'>商品を削除する</span>」をクリックします。</ListFlow>
                        <ListFlowArrow />
                        <ListFlow number={2}>注意事項を確認したら、「<span className='font-bold text-[var(--alert)]'>削除する</span>」ボタンをクリックすると、商品が削除されます。</ListFlow>
                    </ListUl>
