            ...
            <AccordionGrid>
                <Accordion heading="会員登録について・会員の機能">
                    ...
                    <GuideSmall>
                        ...
                        ・
                        <Link href="/privacy-policy" className="hover:underline text-blue-600 hover:text-blue-800">
                            プライバシーポリシー
                        </Link>
                        への同意をお願いします。
                    </GuideSmall>
                ...
                <Accordion heading="メールアドレス・パスワードの設定">
                    <p className="mt-4 mb-2">
                        パスワードは<span className="text-red-500 font-semibold">8文字以上</span>、
                        <span className="text-blue-700">半角英数字（英字、数字それぞれ1文字以上）</span>
                        で設定してください。
                    </p>
                ...
                <Accordion heading="会員登録完了メールの送信">
                    <p className="mt-4 mb-2">
                        メールアドレス・パスワードを登録したら、会員登録完了メールを送信します。
                        <br />
                        会員登録完了メールから、ホーム画面もしくはプロフィール編集画面へアクセスできます。
                    </p>
                    <GuideSmall>
                        ※メールアドレスが<span className="text-red-500">正しく入力</span>
                        されていないと、メールが届かない場合があります。
                    </GuideSmall>
                </Accordion>
                ...
                <Accordion heading="会員登録ができない">
                    ...
                    <GuideSmall className="mt-4">
                        ※
                        一度会員登録を完了したが、後日アカウントが削除された場合、何らかの利用規約違反が確認された可能性が考えられます。
                        <br />
                        詳細は
                        <a href="/terms-and-conditions" className="hover:underline text-blue-600 hover:text-blue-800">
                            利用規約
                        </a>
                        をご覧ください。また、会員登録できない及び削除された原因がわからない場合、お問い合わせフォームにてお問い合わせください。
                    </GuideSmall>
                </Accordion>
            </AccordionGrid>
        </>
