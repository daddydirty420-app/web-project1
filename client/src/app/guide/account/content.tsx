        ...
        <>
            ...
            <AccordionGrid>
                ...
                <Accordion heading='ログイン方法'>
                    <ListUl>
                        ...
                        <ListFlowArrow />
                        <ListFlow number={2}>登録した<span className='text-red-600'>メールアドレス</span>、<span className='text-blue-700'>パスワード</span>を入力し、「ログイン」ボタンをクリック</ListFlow>
                    </ListUl>
                </Accordion>
                ...
                <Accordion heading='ログインできない'>
                    ...
                    <p className='mt-4'>ログインできない理由がわからない場合、お問い合わせフォームにてお問い合わせください。</p>
                </Accordion>
            ...
            <AccordionGrid>
                ...
                <Accordion heading='マイページの内容'>
                    ...
                    <ListUl>
                        ...
                        <ListUlSecond>
                            ...
                            <ListDiscSecond>FLEX OUTDOORについて</ListDiscSecond>
                        </ListUlSecond>
                    </ListUl>
                    <Nado />
                ...
                <Accordion heading='プロフィール情報・アカウント情報の設定'>
                    <p className='mt-4 mb-2'><span className='text-blue-700'>会員登録後</span>、マイページからプロフィール情報やアカウント情報の登録が可能になります。<br />プロフィール情報、アカウント情報は以下の内容を登録することができます。</p>
                ...
                <Accordion heading='プロフィールを変更したい'>
                    <ListUl>
                        <ListFlow number={1}>「<span className='text-blue-700'>プロフィール設定</span>」にアクセス</ListFlow>
                        <ListFlowArrow />
                        <ListFlow number={2}>新しいプロフィールの内容をそれぞれ入力し、「<span className='text-red-600'>登録する</span>」ボタンを押したら、変更完了です。</ListFlow>
                    </ListUl>
                </Accordion>

                <Accordion heading='個人情報を変更したい'>
                    <ListUl>
                        <ListFlow number={1}>「<span className='text-blue-700'>個人情報設定</span>」にアクセスし、変更したい項目を選びます。</ListFlow>
                        <ListFlowArrow />
                        <ListFlow number={2}>新しい内容をそれぞれ入力し、「<span className='text-red-600'>登録する</span>」ボタンを押したら、変更完了です。</ListFlow>
                    </ListUl>
                </Accordion>

                <Accordion heading='口座情報の設定'>
                    <p>マイページまたは個人情報設定から振込口座を設定できます。
                        <br />
                        <span className='font-bold'>出品を希望する方は必ず入力してください！</span>
                    </p>
                    <GuideSmall>※口座情報を登録していないと、<span className='text-red-600'>売上金を受け取れない</span>場合があります。</GuideSmall>
                </Accordion>
                ...
                <Accordion heading='本人確認について'>
                    ...
                    <GuideSmall className='mt-6'>身分証は必ず<span className='text-red-600'>顔写真、名前、住所、生年月日</span>が記載されているものを登録してください。</GuideSmall>
