        ...
        <>
            ...
            <section className='max-w-[768px] m-auto mb-[3rem]'>
                <TermsMiniSection number={1} heading='総則'>
                    <p>（1）ウェブサービスである「○○」（以下「本サービス」といいます。）を運営する○○（以下「弊社」といいます。）は、本サービスのユーザー（以下「ユーザー」といいます。）のプライバシーを尊重し、ユーザーの個人情報及びその他のユーザーのプライバシーに係る情報（以下「プライバシー情報」といいます。）の管理に細心の注意を払うため、弊社は、本プライバシーポリシーに基づいて、プライバシー情報を扱います。
