    ...
    return (
        <>
            ...
            <section className={styles.mainSec}>
                ...
                <MainP>
                    1つの商品につき、<strong>在庫を何点でも登録できます</strong>。
                    <br />
                    また、新しく入荷したら、商品の編集画面で<strong>すぐに在庫の追加が可能です</strong>。
                    <br />
                    <strong>専用の在庫管理画面</strong>も用意しております。
                </MainP>
            </section>
            ...
            <section className={styles.mainSec}>
                ...
                <MainP>
                    商品1点ずつの売上データだけでなく、
                    <strong>商品ごとの売上データや日々の売上推移、登録からの月ごとの売上推移</strong>
                    など、詳細な売上データを閲覧することができ、貴社のマーケティングに役立ちます。
                    <br />
                    また、売上データ閲覧時に、すぐに振込申請することも可能です。
                </MainP>
            </section>
            ...
            <section className={styles.mainSec}>
                ...
                <MainP>
                    任意でオプション設定から自動振込をお申込みいただくと、
                    <strong>毎月自動で指定された口座へ売上金を入金いたします</strong>。
                    <br />
