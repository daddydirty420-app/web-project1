...
export const MainQA = () => {
    return (
        <>
            ...
            <Answer>
                お客様の口座への振込時に<strong>200円</strong>振込手数料が発生します。
            </Answer>

            <Question>送料はどのように設定できますか？</Question>
            <Answer>
                配送料は発払いのみで、表示価格に送料や税額などすべて含んだ額を表示します。価格設定時に、送料などを計算したうえで、すべて含んだ額を設定してください。
            </Answer>

            <Question>画像・動画のファイル形式は何が利用できますか？</Question>
            <Answer>
                画像ファイルはjpeg,jpg,png,webpなどがご利用いただけます。
                <br />
                動画ファイルはmp4,mov,webmなどがご利用いただけます。
            </Answer>
        </>
    );
};
