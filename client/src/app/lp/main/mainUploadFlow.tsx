    ...
    return (
        <>
            ...
            <section className={styles.mainSec}>
                <MainH3>
                    <span className="text-[var(--theme)]">STEP 2</span>
                </MainH3>
                <UploadButton loggedIn={loggedIn} />
                <MainP>
                    「出品する」ボタンを押して、動画や商品画像、商品説明などを入力して、商品をアップロード。これで、出品完了！
                </MainP>
            </section>
            ...
            <section className={styles.mainSec}>
                ...
                <MainP>
                    取引成立後、事前に設定していただいた配送手段、発送日の通りにご発送ください。購入者が商品を受け取り、出品者評価を完了したら、取引完了です。
                </MainP>
            </section>
