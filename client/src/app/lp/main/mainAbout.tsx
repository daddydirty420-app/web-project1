...
export default function MainAbout({ shopPage }: Props) {
    return (
        ...
        <section className={styles.mainSec}>
            ...
            <dl className={styles.dl}>
                ...
                <div className={styles.exampleAll}>
                    <dd className={styles.dd}>テント<br />タープ<br />シュラフ<br />焚き火台</dd>
                    <dd className={styles.dd}>バーナー<br />ハンモック<br />調理器具<br />コンロ</dd>
                    <dd className={styles.dd}>ランタン<br />ライト<br />テーブル<br />チェア</dd>
                    <dd className={styles.nado}>など</dd>
                </div>
                <dt className={styles.dt}>例：登山</dt>
                <div className={styles.exampleAll}>
                    <dd className={styles.dd}>テント<br />タープ<br />シュラフ<br />冬山ギア</dd>
                    <dd className={styles.dd}>トレッキングポール<br />ヘッドランプ<br />ヘルメット<br />クライミングギア</dd>
                    <dd className={styles.nado}>など</dd>
                </div>
                <dt className={styles.dt}>例：ウェア・シューズ</dt>
                <div className={styles.exampleAll}>
                    <dd className={styles.dd}>マウンテンパーカー<br />トレッキングパンツ<br />レインウェア<br />トレランシューズ</dd>
                    <dd className={styles.dd}>登山靴<br />tシャツ<br />サングラス<br />帽子</dd>
                    <dd className={styles.nado}>など</dd>
                </div>
            </dl>
            <Image
        ...
        <section className={styles.mainSec}>
            ...
            <MainP>これらのメリットを踏まえたうえで、商品や出品者に関して、
                <strong>お客様に伝えたいことが伝われば、どんな動画でも構いません。</strong>
            </MainP>
            <MainP>使用感を話す、実際のシーンを映す、CM風に仕上げるなど、自由な形式で投稿できます。また、数秒のショート動画から、映画のような長編動画まで、500MB以内であれば長さも自由！</MainP>
            <MainP>
                <strong>「商品が魅力的」「動画が面白い</strong>
                といった理由で、選ばれることを目指しましょう！
            </MainP>
            <small className={styles.small}>※ 掲載できない動画もございます。詳しくは利用規約をご確認ください。</small>
            <Image
            src={CameraPic}
            alt="動画撮影の風景"
            width={280}
