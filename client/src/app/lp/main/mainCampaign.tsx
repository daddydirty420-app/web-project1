        ...
        <>
            ...
            <section className={styles.mainSec}>
                ...
                <div className="ml-4 mb-4">
                    <p className="text-sm">
                        1点：<strong>100pt</strong>
                        <br />
                        5点：<strong>500pt</strong>
                        <br />
                        10点：<strong className="text-[var(--theme-sub)]">1,000pt</strong>
                        <br />
                        20点：<strong className="text-[var(--theme)]">2,000pt</strong>
                    </p>
                </div>
            ...
            <section className={styles.mainSec}>
                ...
                <MainP>
                    早期出品された方に限り、<strong>テントのバッジ</strong>が貼られます。
                    <FontAwesomeIcon icon={faCampground} className={styles.tentIcon} />
                    これにより、購入者も早期出品された方の判別が可能になり、先駆者ならではの
                    <strong>信頼と安心感</strong>を与えることができます！
                </MainP>
            </section>
            ...
            <section className={styles.mainSec}>
                ...
                <MainP>
                    早期出品期間中に紹介コードを入力したユーザーが出品すると、
                    <strong>
                        紹介先・紹介元ともに、<span className="text-[var(--theme)]">1,000pt</span>お配りします！
                    </strong>
                </MainP>
                <MainP>紹介コードは会員登録・ログイン後、マイページから発行できます！</MainP>
                <small className={styles.small}>
                    ※ 同じ紹介コードをご入力いただけるのは<strong>2名まで</strong>
                    です。3名以上でも入力できますが、ポイントはお配りできません。
                    <br />※ 紹介コードをマイページから発行できるのは、1点以上出品したユーザーのみです。
                    <br />※ 紹介先のユーザーが出品するまで、ポイントは配布されません。
                </small>
            </section>
        </>
    );
