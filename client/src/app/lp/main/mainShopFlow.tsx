...
export const MainShopFlow = () => {
    return (
        ...
        <ShopFlowP>審査に約1～2週間ほどお時間を頂戴しております。審査が完了しましたら、メールにてお知らせいたします。</ShopFlowP>
        <small className={styles.small}>※ 審査の結果ショップ登録できない場合、ショップ登録時に入力していただいた情報はすべて削除されます。</small>

        <ShopStep number={7}><span className="text-[var(--theme)]">出品開始！</span></ShopStep>
