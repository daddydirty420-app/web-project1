...
export const Hero = ({ shopPage }: Props) => {
    return (
        <div className={styles.headerDiv}>
            ...
            />
            <div>
                <p className={clsx('absolute top-[25%] left-[5%]', styles.headerText)}>
                    自慢のギアを動画で<span className="text-[var(--theme)]">FLEX</span>！！
                </p>
                {!shopPage && (
                    <p className={clsx('absolute top-[43%] left-[5%]', styles.headerText)}>
                        <span className="text-[var(--theme)]">FLEX</span>で楽しい、新体験のアウトドア売買
                    </p>
                )}
                {shopPage && (
                    <p className={clsx('absolute top-[43%] left-[5%]', styles.headerText)}>
            ...
            <div className={styles.headerFlexDiv}>
                <p className={styles.headerText2}>
                    <span className="text-[var(--theme)]">早期出品者大募集中</span>！
                </p>
                <p className={styles.headerText2}>
                    <span className="text-[var(--theme)]">2026年冬</span>オープン
                </p>
            </div>
        </div>
    );
