...
export const UploadButton = ({ id }: Props) => {
    ...
    return (
        <>
            <button type="button" className={styles.uploadButton} onClick={() => setPopup(true)}>
                出品する
            </button>

            <Link href={`/upload/edit/${id}`} className={styles.editButton}>
                商品を編集する
            </Link>
                    ...
                    <div className={styles.popup}>
                        ...
                        <div className={styles.termsDiv}>
                            ...
                            <TermsList
                                number={2}
                                fontSize="small"
                                text="景品表示法や薬機法等に反する内容を含むコンテンツ"
                            />
                            <TermsList number={3} fontSize="small" text="性的なコンテンツ" />
                            <TermsList
                                number={4}
                                fontSize="small"
                                text="社会通念上、不健全またはわいせつと認められるコンテンツ"
                            />
                            <TermsList
                                number={5}
                                fontSize="small"
                            ...
                            <TermsList
                                number={7}
                                fontSize="small"
                                text="商品ページでの説明と異なる条件を提示する内容のコンテンツ"
                            />
                            <TermsList
                                number={8}
                                fontSize="small"
                                text="他者を不快にさせたり、他者の迷惑となる行為を含むコンテンツ"
                            />
                        ...
                        <div className={styles.termsDiv}>
                            ...
                            <TermsList
                                number={4}
                                fontSize="small"
                                text="電子チケットや電子クーポン、QRコードなどの電子データ"
                            />
                            <TermsList
                                number={5}
                                fontSize="small"
                                text="新型コロナウイルスの影響に伴い、取引が禁止されている商品"
                            />
                            ...
                            <TermsList
                                number={10}
                                fontSize="small"
                                text="生もの等衛生上管理が難しい食品類又は開封済みのもの"
                            />
                            ...
                            <TermsList
                                number={21}
                                fontSize="small"
                                text="アダルト関連商材、児童ポルノやそれに類するとみなされるもの"
                            />
                            ...
                            <TermsList
                                number={25}
                                fontSize="small"
                                text="レンタル品など、出品者への返送を必要とするもの"
                            />
                            <TermsList
                                number={26}
                                fontSize="small"
                                text="リコール製品のうち、改善対策済みではないもの"
                            />
                            <TermsList
                                number={27}
                                fontSize="small"
                        ...
                        <button type="button" className={styles.popupButton} onClick={upload}>
                            出品する
                        </button>
                    </div>
                </>
