    ...
    return (
        <>
            <div className={styles.buttonDiv}>
                <button type="button" className={styles.saleButton} onClick={() => setSalePopup(true)}>
                    値引きする
                </button>
                {sale?.sale_flag && (
                    <button type="button" className={styles.saleStopButton} onClick={() => setSaleStopPopup(true)}>
                        値引きをやめる
                    </button>
                )}
            </div>
            ...
            {salePopup && (
                <>
                    ...
                    <div className={styles.popup}>
                        <X strokeWidth={1.5} className={styles.x} onClick={() => setSalePopup(false)} />
                        ...
                        <button type="button" className={styles.popupButton} onClick={update}>
                            値引きする
                        </button>
                    </div>
                </>
            ...
            {saleStopPopup && (
                <>
                    ...
                    <div className={styles.popup}>
                        ...
                        <button type="button" className={styles.popupButton} onClick={end}>
                            値引きをやめる
                        </button>
                    </div>
                </>
