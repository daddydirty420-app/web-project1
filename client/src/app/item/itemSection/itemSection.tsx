...
export default function ItemSection({ id, item, sellerMe, page, session, accessToken }: Props) {
    return (
        <section className={styles.itemSection}>
            ...
            {!sellerMe && page === "normal" && !item.sold_out && <BuySection id={id} item={item} session={session} accessToken={accessToken} />}
