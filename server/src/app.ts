...
import RecommendItemRouter from './routes/recommend_item.js';
import RecommendMonthRouter from './routes/recommend_month.js';
import RecommendPaidInfoRouter from './routes/recommend_paid_info.js';
...
app.use('/api/recommend-item', RecommendItemRouter);
app.use('/api/recommend-month', RecommendMonthRouter);
app.use('/api/recommend-paid-info', RecommendPaidInfoRouter);
