...
import { CartListParams, DestroyAllParams, DestroyParams, ItemIdParams, ItemUserParams } from "../types/serviceType/cart.js";
...
export const getUserItemsCartList = async ({ itemWhere, limit, offset, userId }: CartListParams) => {
    ...
    .map((cart: InstanceType<typeof Cart>) => cart.Item);
