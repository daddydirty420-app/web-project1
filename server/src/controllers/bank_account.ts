...
export const bankAccountPostByIdShopController = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
...
// summary: 口座情報変更
// page: /edit/account
export const bankAccountPatchByIdController = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
