...
// summary: いいね削除
// page: /item
export const commentLikeDeleteByIdController = async (
    req: Request,
    res: Response,
    next: NextFunction,
): Promise<void> => {
...
// summary: いいねステータス取得
// page: /item
export const commentLikeGetByIdStatusController = async (
    req: Request,
    res: Response,
    next: NextFunction,
): Promise<void> => {
...
// summary: いいね数取得
// page: /item
export const commentLikeGetByIdCountController = async (
    req: Request,
    res: Response,
    next: NextFunction,
): Promise<void> => {
...
export const commentLikeGetByIdUserController = async (
    req: Request,
    res: Response,
    next: NextFunction,
): Promise<void> => {
