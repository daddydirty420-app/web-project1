...
// summary: 認証コード再送信
// page: /signup/verify
export const authPostResendVerificationCodeController = async (
    req: Request,
    res: Response,
    next: NextFunction,
): Promise<void> => {
...
// summary: サインアップコード認証
// page: /signup/verify
export const authPostSignupVerifyController = async (
    req: Request,
    res: Response,
    next: NextFunction,
): Promise<void> => {
...
export const authPostRequestPasswordResetController = async (
    req: Request,
    res: Response,
    next: NextFunction,
): Promise<void> => {
...
// summary: トークンリフレッシュ
// page: middleware
export const authPostRefreshTokenController = async (
    req: Request,
    res: Response,
    next: NextFunction,
): Promise<void> => {
...
// summary: パスワード再ハッシュ
// page:
export const authPostRehashPasswordController = async (
    req: Request,
    res: Response,
    next: NextFunction,
): Promise<void> => {
