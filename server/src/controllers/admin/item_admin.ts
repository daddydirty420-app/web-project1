...
// summary: 商品強制削除
// page: /item/admin/[id]
export const adminItemAdminDeleteByIdController = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
...
// page: /item/admin/[id]
export const adminItemAdminGetByIdItemPageController = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        const itemId = Number(req.params.id);
