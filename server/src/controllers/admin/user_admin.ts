...
import { AddPenaltyBody, DeleteUriageBody } from "../../validators/body/admin/users.js";

// DELETE /admin/user/:id
// summary: ユーザー強制削除
// page: /profile/admin/[id]
export const adminUserAdminDeleteByIdController = async (
    req: Request,
    res: Response,
    next: NextFunction,
): Promise<void> => {
...
// summary: ペナルティポイント追加
// page: /profile/admin/[id]
export const adminUserAdminPatchByIdAddPenaltyController = async (
    req: Request,
    res: Response,
    next: NextFunction,
): Promise<void> => {
...
// summary: 売上金没収
// page: /profile/admin/[id]
export const adminUserAdminPatchByIdDeleteUriageController = async (
    req: Request,
    res: Response,
    next: NextFunction,
): Promise<void> => {
...
// page: /profile/admin/[id]
export const adminUserAdminGetByIdProfileController = async (
    req: Request,
    res: Response,
    next: NextFunction,
): Promise<void> => {
