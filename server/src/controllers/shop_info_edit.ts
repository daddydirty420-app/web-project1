...
export const shopInfoEditPostByIdAddressController = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
...
export const shopInfoEditPostByIdBankAccountController = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        const shopId = Number(req.params.id);
        const userId = req.user!.id;
...
export const shopInfoEditPostByIdRepNameController = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        const shopId = Number(req.params.id);
        const userId = req.user!.id;
...
export const shopInfoEditPostByIdCompanyNameController = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        const shopId = Number(req.params.id);
        const userId = req.user!.id;
...
export const shopInfoEditPostByIdComFreeController = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        const shopId = Number(req.params.id);
        const userId = req.user!.id;
...
export const shopInfoEditGetByIdAddressController = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        const shopEditId = Number(req.params.id);
        const userId = req.user!.id;
...
export const shopInfoEditGetByIdBankAccountController = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        const shopEditId = Number(req.params.id);
        const userId = req.user!.id;
...
export const shopInfoEditGetByIdRepNameController = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        const shopEditId = Number(req.params.id);
        const userId = req.user!.id;
...
export const shopInfoEditGetByIdConNameController = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        const shopEditId = Number(req.params.id);
        const userId = req.user!.id;
...
// page: /edit/shop/com-free/confirm/[id]
export const shopInfoEditGetByIdComFreeConfirmController = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        const shopEditId = Number(req.params.id);
        const userId = req.user!.id;
