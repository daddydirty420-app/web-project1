...
export default {
    ...
    async down(queryInterface, Sequelize) {
        ...
        await queryInterface.removeConstraint(
            "delivery",
            "delivery_address_id_unique"
        );
        await queryInterface.removeConstraint(
            "delivery",
            "delivery_account_id_unique"
        );

        // shop_info
        await queryInterface.removeConstraint(
            "shop_info",
            "shop_info_name_representative_id_unique"
        );
        await queryInterface.removeConstraint(
            "shop_info",
            "shop_info_name_contact_id_unique"
        );
        await queryInterface.removeConstraint(
            "shop_info",
            "shop_info_address_id_unique"
        );
        await queryInterface.removeConstraint(
            "shop_info",
            "shop_info_account_id_unique"
        );

        // shop_info_edit
        await queryInterface.removeConstraint(
            "shop_info_edit",
            "shop_info_edit_name_representative_id_unique"
        );
        await queryInterface.removeConstraint(
            "shop_info_edit",
            "shop_info_edit_name_contact_id_unique"
        );
        await queryInterface.removeConstraint(
            "shop_info_edit",
            "shop_info_edit_address_id_unique"
        );
        await queryInterface.removeConstraint(
            "shop_info_edit",
            "shop_info_edit_account_id_unique"
        );
    },
};
